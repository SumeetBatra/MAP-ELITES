...
def parse_args(argv=None):
    ...
    parser.add_argument('--random_init', type=int, default=500, help='How many policies to initially store in the elites map with random initialization')
    parser.add_argument('--random_init_batch', type=int, default=100, help='Number of policies for random initialization')
