...
if __name__ == '__main__':
    filepath = './checkpoints/checkpoint_083008750/archive_CVT-MAP-ELITES_QDAnt_seed_0_dim_map_4_83008750.dat'
    df = pd.read_csv(filepath, sep=' ')
    df = df.to_numpy()[:, :-1]
    elites = np.where(df[:, 0] >= 2500)
    df_elites = df[elites]
    ...
    for policy_id in rand_policies[:10]:
        ...
        policy_path = f'checkpoints/checkpoint_083008750/policies/CVT-MAP-ELITES_QDAnt_seed_0_dim_map_4_actor_{int(policy_id)}.pt'
